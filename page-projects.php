...
$regions = [
    [ 'key' => 'VIC', 'name' => 'Victoria',        'image' => ventech_image_url( 'region-vic.jpg' ) ],
    [ 'key' => 'NSW', 'name' => 'New South Wales',  'image' => ventech_image_url( 'region-nsw.jpg' ) ],
    [ 'key' => 'QLD', 'name' => 'Queensland',       'image' => ventech_image_url( 'region-qld.jpg' ) ],
];
?>
    ...
    <div class="container">
        ...
        <div class="projects-grid" id="projects-grid">
            <?php foreach ( $regions as $region ) : ?>
                <article
                    class="project-card"
                    data-region="<?php echo esc_attr( $region['key'] ); ?>">
